            ...
            <div class="container">
                ...
                <div class="row card card-body">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" v-model="tableData.search"  @input="listService()" placeholder="Search....">
                        <hr>
                        ...
                        <data-table class="mt-5" :columns="columns" :sortKey="sortKey" :sortOrders="sortOrders" @sort="sortBy">
                            <tbody v-for="(list, idx) in services" :key="idx">
                                <tr class="tr-shadow">
                                    <td>
                                        <img class="img-thumbnail logo-sc" :src="list.image == null ? '../img/logo.jpg' :'../storage/service/'+list.image" />
                                            <div class="">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button class="btn btn-sm btn-b-n"  @click="editService(list)">
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-header">
                        ...
                        <div class="modal-footer text-center">
                            <button type="button" @click="saveService()" class="btn btn-b-n">{{ btncap }}</button>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="logo-view text-center">
                                        <img class="logo-upload" :src="upload.image == null ? '../img/logo.jpg' :'../storage/service/'+upload.image">
